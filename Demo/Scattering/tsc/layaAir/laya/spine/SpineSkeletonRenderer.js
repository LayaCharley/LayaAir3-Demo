        ...
        for (let i = 0, n = drawOrder.length; i < n; i++) {
            ...
            if (texture != null) {
                ...
                if (clipper.isClipping()) {
                    ...
                    graphics.drawTriangles(texture.realTexture, 0, 0, mVertices, mUVs, new Uint16Array(clippedTriangles), Matrix.EMPTY, alpha, colorNum, blendMode);
                }
                else {
                    ...
                    graphics.drawTriangles(texture.realTexture, 0, 0, mVertices, mUVs, new Uint16Array(triangles), Matrix.EMPTY, alpha, colorNum, blendMode);
                }
            }
            clipper.clipEndWithSlot(slot);
        }
