...
export class PrimitiveMesh {
    ...
    static _createMesh(vertexDeclaration, vertices, indices) {
        ...
        var vertexBuffer = LayaGL.renderOBJCreate.createVertexBuffer3D(vertices.length * 4, BufferUsage.Static, true);
        ...
        var indexBuffer = LayaGL.renderOBJCreate.createIndexBuffer3D(IndexFormat.UInt16, indices.length, BufferUsage.Static, true);
...
//# sourceMappingURL=PrimitiveMesh.js.map
