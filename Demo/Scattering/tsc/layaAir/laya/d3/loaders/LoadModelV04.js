...
export class LoadModelV04 {
    ...
    static READ_MESH() {
        ...
        for (i = 0; i < vertexBufferCount; i++) {
            ...
            var vertexBuffer = LayaGL.renderOBJCreate.createVertexBuffer3D(vbDatas.length * 4, BufferUsage.Static, true);
        ...
        var indexBuffer = LayaGL.renderOBJCreate.createIndexBuffer3D(IndexFormat.UInt16, ibLength / 2, BufferUsage.Static, true);
...
//# sourceMappingURL=LoadModelV04.js.map
