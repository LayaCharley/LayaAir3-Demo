...
export class SceneLoad4 {
    ...
    createParticle() {
        ...
        for (let i = 0; i < nNum; i++) {
            ...
            var sp = Sprite3D.instantiate(this.particles[i % 5], this._scene, false, new Vector3((-this.monkeyRow / 2 + x), 9, 20 + -y));
    ...
    loadStaticModel() {
        ...
        Mesh.load("res/threeDimen/pbrtest/PBRAssets02/Sphere.lm", Handler.create(this, function (mesh) {
            var meshSprite3D = new MeshSprite3D(mesh);
            _this.skinmodels.push(meshSprite3D);
            //实例PBR材质
            var sphereMat = new PBRStandardMaterial();
            //albedoTexture:法线贴图：增强模型细节
            //反射贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets02/Materials/Textures/Barrel_AlbedoTransparency.png', Handler.create(this, function (texture) {
                sphereMat.albedoTexture = texture;
            }));
            //法线贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets02/Materials/Textures/Barrel_Normal.png', Handler.create(this, function (texture) {
                sphereMat.normalTexture = texture;
            }));
            //金属光滑度贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets02/Materials/Textures/Barrel_MetallicSmoothness.png', Handler.create(this, function (texture) {
                sphereMat.metallicGlossTexture = texture;
            }));
            //遮挡贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets02/Materials/Textures/Barrel_Occlusion.png', Handler.create(this, function (texture) {
        ...
        //加载Mesh 水桶
        Mesh.load("res/threeDimen/pbrtest/PBRAssets01/Mesh/Wooden_Barrel-Barrel_Low[28772].lm", Handler.create(this, function (mesh) {
            var meshSprite3D = new MeshSprite3D(mesh);
            _this.skinmodels.push(meshSprite3D);
            //实例PBR材质
            var barrelMat = new PBRStandardMaterial();
            //albedoTexture:法线贴图：增强模型细节
            //反射贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets01/Materials/Textures/Barrel_AlbedoTransparency.png', Handler.create(this, function (texture) {
                barrelMat.albedoTexture = texture;
            }));
            //法线贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets01/Materials/Textures/Barrel_Normal.png', Handler.create(this, function (texture) {
                barrelMat.normalTexture = texture;
            }));
            //金属光滑度贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets01/Materials/Textures/Barrel_MetallicSmoothness.png', Handler.create(this, function (texture) {
                barrelMat.metallicGlossTexture = texture;
            }));
            //遮挡贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets01/Materials/Textures/Barrel_Occlusion.png', Handler.create(this, function (texture) {
        ...
        Mesh.load("res/threeDimen/skinModel/LayaMonkey/Assets/LayaMonkey/LayaMonkey-LayaMonkey.lm", Handler.create(this, function (mesh) {
            ...
            _this.skinmodels.push(meshSprite3D);
            //实例PBR材质
            var layaMonkeyMat = new PBRStandardMaterial();
            //albedoTexture:法线贴图：增强模型细节
            //反射贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets03/Materials/Textures/Barrel_AlbedoTransparency.png', Handler.create(this, function (texture) {
                layaMonkeyMat.albedoTexture = texture;
            }));
            //法线贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets03/Materials/Textures/Barrel_Normal.png', Handler.create(this, function (texture) {
                layaMonkeyMat.normalTexture = texture;
            }));
            //金属光滑度贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets03/Materials/Textures/Barrel_MetallicSmoothness.png', Handler.create(this, function (texture) {
                layaMonkeyMat.metallicGlossTexture = texture;
            }));
            //遮挡贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets03/Materials/Textures/Barrel_Occlusion.png', Handler.create(this, function (texture) {
        ...
        Mesh.load("res/threeDimen/staticModel/teapot/teapot-Teapot001.lm", Handler.create(this, function (mesh) {
            ...
            _this.skinmodels.push(meshSprite3D);
            //实例PBR材质
            var teapotMat = new PBRStandardMaterial();
            //albedoTexture:法线贴图：增强模型细节
            //反射贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets04/Materials/Textures/Barrel_AlbedoTransparency.png', Handler.create(this, function (texture) {
                teapotMat.albedoTexture = texture;
            }));
            //法线贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets04/Materials/Textures/Barrel_Normal.png', Handler.create(this, function (texture) {
                teapotMat.normalTexture = texture;
            }));
            //金属光滑度贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets04/Materials/Textures/Barrel_MetallicSmoothness.png', Handler.create(this, function (texture) {
                teapotMat.metallicGlossTexture = texture;
            }));
            //遮挡贴图
            Texture2D.load('res/threeDimen/pbrtest/PBRAssets04/Materials/Textures/Barrel_Occlusion.png', Handler.create(this, function (texture) {
    ...
    createSkinmodel() {
        var nNum = this.modelRow * this.modelRow;
        for (let i = 0; i < nNum; i++) {
            var x = parseInt((i / this.modelRow).toString());
            var y = parseInt((i % this.modelRow).toString());
            var sp = Sprite3D.instantiate(this.skinmodels[i % 4], this._scene, false, new Vector3((-this.modelRow / 2 + x), 9, 20 + -y));
            this._scene.addChild(sp);
        }
    }
}
