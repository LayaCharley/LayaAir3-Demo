...
export class SkeletonMask {
    constructor() {
        ...
        Laya.init(0, 0).then(() => {
            ...
            this.loadFont();
            //加载场景
            Scene3D.load("res/threeDimen/LayaScene_MaskModelTest/Conventional/MaskModelTest.ls", Handler.create(this, function (scene) {
    ...
    loadFont() {
        Laya.loader.load("res/threeDimen/LayaScene_MaskModelTest/font/fontClip.fnt", Loader.FONT).then((res) => {
