...
export class AnimationLayerBlend {
    constructor() {
        ...
        /**实例类型*/
        this.btype = "AnimationLayerBlend";
        /**场景内按钮类型*/
        this.stype = 0;
        //初始化引擎
        Laya.init(0, 0).then(() => {
    ...
    loadUI() {
        Laya.loader.load(["res/threeDimen/ui/button.png"], Handler.create(this, function () {
            this.changeActionButton0 = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "动画过渡:否"));
            ...
            this.changeActionButton1 = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "混合模式:全身"));
            ...
            this.changeActionButton2 = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "切换动作:attack_2"));
