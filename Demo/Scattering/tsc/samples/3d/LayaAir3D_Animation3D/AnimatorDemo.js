...
export class AnimatorDemo {
    ...
    onLoadFinish() {
        ...
        //初始化角色精灵
        var role = this._scene.addChild(new Sprite3D());
        //初始化胖子
    ...
    loadUI() {
        Laya.loader.load(["res/threeDimen/ui/button.png"], Handler.create(this, function () {
            this._changeActionButton = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "播放动画"));
            ...
            this._changeActionButton2 = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "切换动作状态"));
