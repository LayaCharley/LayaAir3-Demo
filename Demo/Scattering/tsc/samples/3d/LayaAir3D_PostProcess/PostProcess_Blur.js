...
import { CameraClearFlags } from "laya/d3/core/Camera";
...
export class PostProcess_Blur {
    ...
    constructor() {
        ...
        Laya.init(0, 0).then(() => {
            ...
            BlurEffect.init();
            //加载场景
            Scene3D.load("res/threeDimen/LayaScene_zhuandibanben/Conventional/zhuandibanben.ls", Handler.create(this, function (scene) {
                ...
                var mainCamera = scene.getChildByName("BlurCamera"); // MainCamera//(this.camera as Camera).getChildAt(0) as Camera;
