...
export class MultiTouch {
    constructor() {
        this.text = new Text();
        this._upVector3 = new Vector3(0, 1, 0);
        //初始化引擎
        Laya.init(0, 0).then(() => {
    ...
    onComplete() {
        ...
        //加载小猴子精灵
        var monkey = Loader.createNodes("res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh");
        //猴子精灵添加组件（脚本）
...
class MonkeyScript extends Script {
    constructor() {
        ...
        this.distance = 0.0;
        this.disVector1 = new Vector2(0, 0);
        this.disVector2 = new Vector2(0, 0);
    ...
    onUpdate() {
        var touchCount = InputManager.touchCount;
        if (1 === touchCount) {
            ...
            if (this.twoFirst) {
                ...
                var distance2 = Vector2.scalarLength(this.disVector2);
                //根据移动的距离进行缩放
