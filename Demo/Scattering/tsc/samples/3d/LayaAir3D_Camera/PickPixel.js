...
export class PickPixel {
    ...
    onMouseDown() {
        ...
        var posX = Laya.stage.mouseX / Laya.stage.clientScaleX;
        var posY = Laya.stage.mouseY / Laya.stage.clientScaleY;
    ...
    onComplete() {
        this._thisscene = Laya.stage.addChild(Loader.createNodes("res/threeDimen/scene/CourtyardScene/Courtyard.ls"));
        //加载场景
        ...
        //渲染到纹理的相机
        this.renderTargetCamera = scene.addChild(new Camera(0, 0.1, 1000));
        ...
        Laya.loader.load(["res/threeDimen/ui/button.png"], Handler.create(this, function () {
            this.changeActionButton = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "拾取像素"));
