...
export class CameraDemo {
    constructor() {
        ...
        this._clearColor = new Vector4(0, 0.2, 0.6, 1);
        /**实例类型*/
    ...
    onPreLoadFinish() {
        ...
        //正方体
        var box = sprite.addChild(new MeshSprite3D(PrimitiveMesh.createBox(0.5, 0.5, 0.5)));
    ...
    loadUI() {
        Laya.loader.load(["res/threeDimen/ui/button.png"], Handler.create(this, function () {
            var changeActionButton = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "正透切换"));
            ...
            var changeActionButton2 = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "切换背景"));
