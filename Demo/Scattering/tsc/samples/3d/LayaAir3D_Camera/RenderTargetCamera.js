...
export class RenderTargetCamera {
    ...
    onComplete() {
        ...
        //正方体
        var box = scene.addChild(new MeshSprite3D(PrimitiveMesh.createPlane(6, 6)));
        box.transform.position = new Vector3(-28.8, 8, -65);
        box.transform.rotate(new Vector3(90, 0, 0), true, false);
        var mat = new UnlitMaterial();
        ...
        Laya.loader.load(["res/threeDimen/ui/button.png"], Handler.create(this, function () {
            var changeActionButton = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "渲染目标"));
    ...
    stypeFun0() {
        ...
        //渲染到纹理的相机
        var renderTargetCamera = this.scene.addChild(new Camera(0, 0.3, 1000));
