...
export class GarbageCollection {
    ...
    loadUI() {
        Laya.loader.load(["res/threeDimen/ui/button.png"], Handler.create(this, function () {
            this.changeActionButton = Laya.stage.addChild(new Button("res/threeDimen/ui/button.png", "释放显存"));
     ...
     */
    loadScene() {
        Scene3D.load("res/threeDimen/scene/ParticleScene/Scene.ls", Handler.create(this, function (sprite) {
            this._scene = Laya.stage.addChild(sprite);
