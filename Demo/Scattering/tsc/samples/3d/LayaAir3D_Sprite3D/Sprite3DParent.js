...
export class Sprite3DParent {
    constructor() {
        ...
        Laya.init(0, 0).then(() => {
            ...
            //预加载所有资源
            var resource = ["res/threeDimen/skinModel/LayaMonkey2/LayaMonkey.lh", "res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh"];
            Laya.loader.load(resource, Handler.create(this, this.onPreLoadFinish));
        });
    }
    onPreLoadFinish() {
        //添加父级猴子
        this.layaMonkeyParent = this.scene.addChild(Loader.createNodes("res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh"));
        //加载第二只猴子，作为子猴子
