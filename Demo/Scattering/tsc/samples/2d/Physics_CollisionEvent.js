...
export class Physics_CollisionEvent {
    ...
    createSensor() {
        ...
        let sensorCollider = this.sensorCollider = ground.addComponent(CircleCollider);
        ...
        for (let i = 0, len = this.count; i < len; i++) {
            ...
            let circleCollider = sp.addComponent(CircleCollider);
    ...
    onTriggerEnter(colliderB, colliderA, contact) {
        if (colliderA === this.sensorCollider) {
            let bodyB = colliderB.owner.getComponent(RigidBody);
    ...
    onTriggerStay() {
        ...
        for (let i = 0, len = this.count; i < len; i++) {
            ...
            let bodyA = this.sensorCollider.owner.getComponent(RigidBody);
            let bodyB = body.owner.getComponent(RigidBody);
