...
export class IndexView2D extends IndexViewUI {
    constructor(box, MainCls) {
        ...
        //---------------------------------------------------------------------------------2D------------开始---------------------------------------------
        // 'IDE' '粒子' 去掉 
        this._comboxBigArr = ['Sprite', '动画', '骨骼动画', '混合模式', '区块地图', '滤镜', '点击', '音频', '文本', 'UI', '计时器', '缓动', '鼠标交互', '屏幕适配', '网络和格式', '调试', '性能测试', '物理', 'DOM', '输入设备', 'Loader加载', 'Demo'];
        /************************sprite-start***************************/
        ...
        /************************BlendMode-end***************************/
        /************************TiledMap-start***************************/
        this._comboBoxTiledMapClsArr = [TiledMap_AnimationTile, TiledMap_IsometricWorld, TiledMap_PerspectiveWall, TiledMap_ScrollMap];
        this._comboBoxTiledMapArr = ['带动画的地图', '等角地图', 'PerspectiveWall', '滚动地图'];
        /************************TiledMap-end***************************/
        /************************Filters-start***************************/
        ...
        /************************Interaction-end***************************/
        /************************SmartScale-start***************************/
        this._comboBoxSmartScaleClsArr = [SmartScale_Align_Contral, SmartScale_Landscape, SmartScale_Portrait, SmartScale_Scale_NOSCALE, SmartScale_Scale_EXTRACT_FIT, SmartScale_Scale_NOBORDER, SmartScale_Scale_SHOW_ALL, SmartScale_T];
        this._comboBoxSmartScaleArr = ['缩放-Align 居中', '屏幕-横屏', '屏幕-竖屏', '缩放-NoScale', '缩放-Extract Fit', '缩放-No Border', '缩放-Show All', '屏幕适配'];
        /************************SmartScale-end***************************/
        /************************Network-start***************************/
        ...
        /************************PerformanceTest-end***************************/
        /************************Particle-start***************************/
        this._comboBoxPhysicsClsArr = [Physics_Tumbler, Physics_CollisionFiltering, Physics_CollisionEvent, Physics_Bridge, Physics_Strandbeests];
        this._comboBoxPhysicsArr = ['复合碰撞器', '碰撞过滤器', '碰撞事件与传感器', '桥', '仿生机器人'];
        /************************Particle-end***************************/
        /************************Dom-start***************************/
