...
(function (exports, Laya) {
    ...
    class RigidBody extends Laya.Component {
        ...
        _createBody() {
            ...
            var point = sp.localToGlobal(Laya.Point.TEMP.setTo(0, 0), false, Physics.I.worldRoot);
        ...
        onUpdate() {
            if (this.type != "static" && this._body.IsAwake()) {
                ...
                var point = sp.globalToLocal(Laya.Point.TEMP.setTo(pos.x * Physics.PIXEL_RATIO, pos.y * Physics.PIXEL_RATIO), false, Physics.I.worldRoot);
                point.x += sp.pivotX;
                point.y += sp.pivotY;
        ...
        _sysNodeToPhysic() {
            ...
            var p = sp.localToGlobal(Laya.Point.TEMP.setTo(0, 0), false, Physics.I.worldRoot);
    ...
    class ColliderBase extends Laya.Component {
        ...
        _onEnable() {
            if (this.rigidBody)
                ...
                Laya.ILaya.systemTimer.callLater(this, this._checkRigidBody);
        }
        _checkRigidBody() {
            if (!this.rigidBody) {
    ...
    class MouseJoint extends JointBase {
        ...
        onMouseDown() {
            this._createJoint();
            Laya.ILaya.stage.on(Laya.Event.MOUSE_MOVE, this, this.onMouseMove);
            Laya.ILaya.stage.once(Laya.Event.MOUSE_UP, this, this.onStageMouseUp);
            Laya.ILaya.stage.once(Laya.Event.MOUSE_OUT, this, this.onStageMouseUp);
        }
        _createJoint() {
            if (!this._joint) {
                this.selfBody = this.selfBody || this.owner.getComponent(RigidBody);
                ...
                if (this.anchor) {
                    ...
                    anchorPos = Physics.I.worldRoot.globalToLocal(Laya.Point.TEMP.setTo(Laya.ILaya.stage.mouseX, Laya.ILaya.stage.mouseY));
                }
        ...
        onStageMouseUp() {
            Laya.ILaya.stage.off(Laya.Event.MOUSE_MOVE, this, this.onMouseMove);
            Laya.ILaya.stage.off(Laya.Event.MOUSE_UP, this, this.onStageMouseUp);
            Laya.ILaya.stage.off(Laya.Event.MOUSE_OUT, this, this.onStageMouseUp);
            super._onDisable();
        }
        onMouseMove() {
    ...
    class PhysicsDebugDraw extends Laya.Sprite {
        ...
        static enable(flags = 99) {
            if (!PhysicsDebugDraw.I) {
                ...
                Laya.ILaya.stage.addChild(debug);
