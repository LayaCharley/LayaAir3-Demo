(function (exports, Laya) {
    ...
    class ParticleTemplate2D extends Laya.Resource {
        constructor(settings, texture) {
            ...
            this._blendFn = Laya.BlendMode.fns[settings.blendState];
        ...
        renderSubmit() {
            if (this.texture && this.texture.valid) {
                ...
                if (this._firstActiveElement != this._firstFreeElement) {
                    ...
                    this.sv.upload();
                    if (this._firstActiveElement < this._firstFreeElement) {
                        Laya.LayaGL.renderDrawContext.drawElements2DTemp(Laya.MeshTopology.Triangles, (this._firstFreeElement - this._firstActiveElement) * 6, Laya.IndexFormat.UInt16, this._firstActiveElement * 6 * 2);
                    }
                    else {
                        Laya.LayaGL.renderDrawContext.drawElements2DTemp(Laya.MeshTopology.Triangles, (this.settings.maxPartices - this._firstActiveElement) * 6, Laya.IndexFormat.UInt16, this._firstActiveElement * 6 * 2);
                        if (this._firstFreeElement > 0)
                            Laya.LayaGL.renderDrawContext.drawElements2DTemp(Laya.MeshTopology.Triangles, this._firstFreeElement * 6, Laya.IndexFormat.UInt16, 0);
                    }
                }
                this._drawCounter++;
            }
    ...
    class Particle2D extends Laya.Sprite {
        ...
        set source(value) {
            this._source = value;
            if (value) {
                Laya.ILaya.loader.load(value).then((template) => {
        ...
        init(template) {
            ...
            this.customRenderEnable = true;
            this.graphics.addCmd(Laya.DrawParticleCmd.create(this._template));
            if (!this._emitter) {
    ...
    Laya.Loader.registerLoader(["part"], ParticleTemplate2DLoader);
