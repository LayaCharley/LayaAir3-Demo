...
export class PhysicsWorld_BuildingBlocks extends BaseScript {
	...
	onMouseDown(e: Event): void {
		...
		if (this._outHitResult.succeeded) {
			var collider: Rigidbody3D = <Rigidbody3D>this._outHitResult.collider.owner.getComponent(Laya.Rigidbody3D);
	...
	onMouseMove(e: Event): void {
		...
		this.delX = e.target.mouseX - this.posX * Index.screenWidth / Index.pageWidth - this.posX;
		this.delY = e.target.mouseY - this.posY * Index.screenHeight / Index.pageHeight - this.posY;
