...
export class Physics_Strandbeests extends BaseScript {
    ...
    createLeg(s: number, wheelAnchor : any) {
        ...
        distanceJoint1.maxLength = distanceJoint1.minLength = distanceJoint1.length || distanceJoint1.joint.GetLength() * Physics.I._factory.PIXEL_RATIO;
        ...
        distanceJoint2.maxLength = distanceJoint2.minLength = distanceJoint2.length || distanceJoint2.joint.GetLength() * Physics.I._factory.PIXEL_RATIO;;

        let localAnchor = new box2d.b2Vec2();
        wheelBody.getBody().GetLocalPoint({'x': (this.pos[0] + this.m_offset[0]) / Physics.I._factory.PIXEL_RATIO, 'y': (this.pos[1] + this.m_offset[1]) / Physics.I._factory.PIXEL_RATIO}, localAnchor);
        let anchor = [-localAnchor.x * Physics.I._factory.PIXEL_RATIO, -localAnchor.y * Physics.I._factory.PIXEL_RATIO];
        ...
        distanceJoint3.maxLength = distanceJoint3.minLength = distanceJoint3.length || distanceJoint3.joint.GetLength() * Physics.I._factory.PIXEL_RATIO;;
        ...
        distanceJoint4.maxLength = distanceJoint4.minLength = distanceJoint4.length || distanceJoint4.joint.GetLength() * Physics.I._factory.PIXEL_RATIO;;
    ...
    eventListener() {
        ...
        Laya.stage.on(Event.CLICK, this, (e:Event) => {
            ...
            let circlePosx = circleCollider.x / Physics.I._factory.PIXEL_RATIO;
            let circlePosy = circleCollider.y / Physics.I._factory.PIXEL_RATIO;
