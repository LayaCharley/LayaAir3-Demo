...
@regClass()
export class Particle_T1 extends BaseScript {
    ...
    onAwake(): void {
        ...
        super.base();
        Laya.loader.load("resources/res/particles/GravityMode.part").then((template: ParticleTemplate2D) => {
            ...
            this.sp.y = this.pageHeight / 2 + 250;
        });
    }
